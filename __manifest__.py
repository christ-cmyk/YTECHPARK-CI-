{
    ...
    'data': [
        ...
        'views/inventaire_snapshot_views.xml',
        'views/menus.xml',
        ...
        'wizards/wizard_rapport_inventaire_views.xml',
        'wizards/wizard_rapport_maintenances_views.xml',
        'data/cron.xml',
        'data/it_parc_demo.xml',
        'report/report_fiche_equipement.xml',
        'report/report_inventaire.xml',
        'report/report_maintenances.xml',
        'report/report_recu_contrat.xml',
